...
class ChessApp:
    ...
    def ai_move(self):
        ...
        if self.ai_difficulty == 'easy':
            ...
            if book_move:
                ...
                print(f"Testing time is: {self.total_testing_time:.2f} seconds")
    ...
    def sorting_moves(self):
        ...
        non_capture_moves = []
        for move in self.board.legal_moves:
            if self.is_capture_move(move) and self.is_checkmate_move(move):
    ...
    def minimax_move(self, depth):
        ...
        start_time = time.time()
        moves = self.sorting_moves()
        end_time = time.time()
        self.total_testing_time += end_time - start_time
